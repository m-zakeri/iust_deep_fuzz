REM new file name:	get_all_pdf_coverage_merged
REM old file name:	_cover_batch version 5.0

REM measure code coverage for corpus_merged include all of our pdfs (i.e 6160 items)
REM and merged all in one coverage file, e.g. maximum coverage for corpus.
